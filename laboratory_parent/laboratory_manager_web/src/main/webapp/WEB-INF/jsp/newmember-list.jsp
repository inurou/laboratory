...
<table class="easyui-datagrid" id="itemList" title="新成员申请列表"
       data-options="singleSelect:false,collapsible:true,pagination:true,url:'/newmember/list',method:'get',pageSize:30,toolbar:toolbar">
    <thead>
        <tr>
            ...
            <th data-options="field:'subject',width:400,align:'center'">学院</th>
            <th data-options="field:'major',width:400,align:'center'">专业</th>
            <th data-options="field:'email',width:400,align:'center'">邮箱</th>
            <th data-options="field:'phone',width:400,align:'center'">电话</th>
            <th data-options="field:'honer',width:400,align:'center'">荣誉/特长</th>
        </tr>
    </thead>
</table>
