...
<table class="easyui-datagrid" id="itemList" title="成员列表"
       data-options="singleSelect:false,collapsible:true,pagination:true,url:'/member/list',method:'get',pageSize:30,toolbar:toolbar">
    <thead>
        <tr>
            ...
            <th data-options="field:'grade',width:400,align:'center'">年级</th>
        </tr>
    </thead>
</table>
